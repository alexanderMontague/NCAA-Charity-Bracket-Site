      ...
      <section id="bracket">
            ...
            >
              ...
              <ul className={styles.matchup}>
                ...
                >
                  ...
                  <div className={styles.teamOwner}>Haley Montague</div>
                </li>
              </ul>
              <ul className={styles.matchup}>
                <li className={[styles.team, styles.teamTop].join(" ")}>
                  Wake Forest<span className={styles.score}>64</span>
                  <div className={styles.teamOwner}>Alexander Montague</div>
                </li>
                <li
                  className={[
                    styles.eliminated,
        ...
        <div className={styles.finalsContainer}>
          ...
          <div className={styles.finalsBottom}>
            ...
            <div className={styles.finalTeam}>
              North Carolina
              <div className={styles.teamOwner}>Alex Montague</div>
            </div>
          ...
          <div className={styles.finalFourBottom}>
            ...
            <div className={styles.finalTeam}>
              TEST
              <div className={styles.teamOwner}>Test Montague</div>
            </div>
            <div className={styles.finalTeam}>
              TEST
              <div className={styles.teamOwner}>My Guy</div>
            </div>
          </div>
        </div>
      </section>
